        ...
        <form onSubmit={handleSubmit}>
          ...
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "0.5rem" }}>
            <button
              type="button"
              className="form-btn"
              style={{ backgroundColor: "#ef4444", width: "auto", padding: "0.5rem 1rem", fontSize: "0.875rem" }}
              onClick={async () => {
            ...
            <div style={{ display: "flex", gap: "0.5rem" }}>
              <button
                type="button"
                className="form-btn"
                style={{ backgroundColor: "var(--text-muted)", width: "auto", padding: "0.5rem 1rem", fontSize: "0.875rem" }}
                onClick={() => router.back()}
                disabled={isSubmitting}
              >
                キャンセル
